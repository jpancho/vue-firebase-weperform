...
<script>
  export default {
    data() {
      return {
        team: [
          { name: 'Jason Zhou', role: 'Test analyst | Debugger', avatar: '/Jason.jpg', description: '"Specifies the required Test Data and evaluating the outcome of the testing conducted in each test cycle; skilled with database."', linkedin: '/linkedin.png', github: '/GitHub-Mark-Light-32px.png', url: 'https://www.linkedin.com/in/jasonzhou97', url1: 'https://github.com/JasonZhouE'},
